...
$co = $this->db->select("*")->from("propietario")->where("id",$id_propied)->get()->row();
...
<div class="form-contacto-publicacion bg-gray-100 p-4 mx-auto">
  ...
  <div class="flex items-center mb-4">
    ...
    <p class="text-gray-800"><strong>Teléfono:</strong> <a href="tel: <?= $telpro ?>"><?= $telpro ?></a></p>
  </div>
  <div class="flex items-center">
    <i class="fas fa-envelope text-gray-600 mr-2"></i>
    <p class="text-gray-800"><strong>Correo electrónico:</strong> <a href="mailto: <?= $corpro ?>"><?= $corpro ?></a></p>
  </div>
  <div class="flex items-center mb-4">
