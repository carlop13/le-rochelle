    ...
    <main class="main-content">
        ...
        <?php if ($contpro > 6) : ?>
            <div class="btn-ver-mas-container">
                <button class="btn-ver-mas" value="0" onclick="cargarMasPropiedades(this.getAttribute('data-contador'),<?=$numero?>)" id="botonCargarMas" data-contador="<?= $contador ?>">Ver Más Propiedades</button>
            </div>
        <?php endif;?>
