...
<?php 
elseif($mensaje == "Registro%20Exitoso"):
?>
...
<?php 
elseif($mensaje == "Registro%20Fallido"):
?>
    ...
    <div id="contenedor-admin">
        ...
        <div class="contenedor-principal">
            <div id="nueva-propiedad">
                ...
                <hr>
                <form action="<?=base_url()?>../webservice/backend/insertarProp" enctype="multipart/form-data" method="post">
                   ...
                   value="" />
                    ...
                    <div class="fila-una-columna form-group" id="group-titulo">
                        ...
                        <input type="text" name="titulo" id="titulo" class="input-entrada-texto form-control">
                    </div>

                    <div class="fila-una-colummna form-group" id="group-desc">
                        <label for="desc">Descripción de la Propiedad (opcional)</label>
                        <textarea name="desc" id="desc" cols="150" rows="8" placeholder="La descripción no debe de ser mayor a 900 caracteres" class="input-entrada-texto"></textarea>
                    </div>
                    ...
                    <div class="fila">
                        ...
                        <div class="box" id="group-calle">
                            ...
                            <input type="text" name="calle" id="calle" class="input-entrada-texto">
                        </div>
                    </div>
                    ...
                    <div class="fila">
                        <div class="box" id="group-col">
                            ...
                            <input type="text" name="col" id="col" class="input-entrada-texto">
                        </div>

                        <div class="box" id="group-noext">
                            <label for="noext">Número (opcional)</label>
                            <input type="number" min="0" step="0" name="noext" id="noext" class="input-entrada-texto">
                        </div>

                        <div class="box" id="group-noesta">
                            <label for="noesta">Número de estacionacientos (opcional)</label>
                            <input type="number" min="0" step="0" name="noesta" id="noesta" class="input-entrada-texto">
                        </div>
                    ...
                    <div class="fila">
                        <div class="box" id="group-habitaciones">
                            ...
                            <input type="number" min="0" step="0" name="habitaciones" id="habitaciones" class="input-entrada-texto">
                        </div>

                        <div class="box" id="group-banios">
                            <label for="banios">Baños Completos (opcional)</label>
                            <input type="number" min="0" step="0" name="banios" id="banios" class="input-entrada-texto">
                        </div>

                        <div class="box" id="group-mbanios">
                            <label for="mbanios">Medios Baños (opcional)</label>
                            <input type="number" min="0" step="0" name="mbanios" id="mbanios" class="input-entrada-texto">
                        </div>
                    </div>
                    ...
                    <div class="fila">
                        <div class="box">
                            ...
                            <select name="garage" id="garage" class="input-entrada-texto">
                                ...
                                <option value="noMo">No Mostrar</option>
                            </select>
                        </div>

                        <div class="box" id="group-pisos">
                            <label for="pisos">Pisos (opcional)</label>
                            <input type="number" min="0" step="0" name="pisos" id="pisos" class="input-entrada-texto">
                        </div>

                        <div class="box" id="group-precio">
                            <label for="precio">Precio (Venta o Alquiler)</label>
                            <input type="number" name="precio" id="precio" step="1" min="0" class="input-entrada-texto" >
                        </div>
                    </div>
                    ...
                    <div class="fila">
                        <div class="box" id="group-ancho">
                            ...
                            <input type="text" name="ancho" id="ancho" class="input-entrada-texto">
                        </div>

                        <div class="box" id="group-fondo">
                            <label for="fondo">Fondo (opcional)</label>
                            <input type="text" name="fondo" id="fondo" class="input-entrada-texto">
                        </div>

                        <div class="box" id="group-suptot">
                            <label for="suptot">Superficie Total (opcional)</label>
                            <input type="text" name="suptot" id="suptot" class="input-entrada-texto" >
                        </div>
                    </div>
                    ...
                    <div class="fila">
                        ...
                        <div class="box" id="group-mconst">
                            ...
                            <input type="text" name="mconst" id="mconst" class="input-entrada-texto">
                        </div>
                    ...
                    <div>
                        <label for="fotos" class="btn-fotos"> Galería de Fotos <br>(Selecciona todas las fotos que ocuparás) </label>
                       ...
                       <input type="file" id="fotos" accept="image/*" name="fotos[]" value="Foto" multiple="" class="hidden">
                    ...
                    <div class="fila">
                        ...
                        <div class="box">
                            ...
                            <input type="text" name="nombre_propietario" id="nombre_propietario" class="input-entrada-texto">
                        </div>
                    ...
                    <div class="fila">
                        <div class="box">
                            ...
                            <input type="text" name="apellido_propietario" id="apellido_propietario" class="input-entrada-texto">
                        </div>

                        <div class="box" id="group-telefono_propietario">
                            <label for="telefono_propietario">Teléfono del propietario (opcional)</label>
                            <input type="number" name="telefono_propietario" id="telefono_propietario" class="input-entrada-texto">
                        </div>

                        <div class="box" id="group-correo_propietario">
                            <label for="correo_propietario">Correo del propietario (opcional)</label>
                            <input type="text" name="correo_propietario" id="correo_propietario" class="input-entrada-texto">
                        </div>
...
#search-button:hover {
    ...
    <script src="<?= base_url() ?>static/bootstrap/js/bootstrap.bundle.min.js " rel="stylesheet"></script>
                ...
                <div class="fila">
                        <div class="box">
                            <label for="ubi">Agregar ubicación</label>
...
Haz clic para crear o cambiar posición
    ...
    <script src="<?=base_url()?>static/js/scriptFotos.js"></script>
    <script src="<?=base_url()?>static/js/ubi.js" ></script>
    <script src="<?=base_url()?>static/js/agregarprop.js" ></script>
